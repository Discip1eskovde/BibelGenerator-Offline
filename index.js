...
const BIBLE_BOOKS_MAP = [{
  sv: "1 Mosebok",
  svFull: "Första Moseboken",
  en: "Genesis",
  ar: "تكوين"
}, {
  sv: "2 Mosebok",
  svFull: "Andra Moseboken",
  en: "Exodus",
  ar: "خروج"
}, {
  sv: "3 Mosebok",
  svFull: "Tredje Moseboken",
  en: "Leviticus",
  ar: "لاويين"
}, {
  sv: "4 Mosebok",
  svFull: "Fjärde Moseboken",
  en: "Numbers",
  ar: "عدد"
}, {
  sv: "5 Mosebok",
  svFull: "Femte Moseboken",
  en: "Deuteronomy",
  ar: "تثنية"
}, {
  sv: "Josua",
  ...
  sv: "1 Samuelsboken",
  svFull: "Första Samuelsboken",
  en: "1 Samuel",
  ar: "صموئيل الأول"
}, {
  sv: "2 Samuelsboken",
  svFull: "Andra Samuelsboken",
  en: "2 Samuel",
  ar: "صموئيل الثاني"
}, {
  sv: "1 Kungaboken",
  svFull: "Första Kungaboken",
  en: "1 Kings",
  ar: "ملوك الأول"
}, {
  sv: "2 Kungaboken",
  svFull: "Andra Kungaboken",
  en: "2 Kings",
  ar: "ملوك الثاني"
}, {
  sv: "1 Krönikeboken",
  svFull: "Första Krönikeboken",
  en: "1 Chronicles",
  ar: "أخبار الأيام الأول"
}, {
  sv: "2 Krönikeboken",
  svFull: "Andra Krönikeboken",
  en: "2 Chronicles",
  ...
  sv: "Matteus",
  svFull: "Matteusevangeliet",
  en: "Matthew",
  ar: "متى"
}, {
  sv: "Markus",
  svFull: "Markusevangeliet",
  en: "Mark",
  ar: "مرقس"
}, {
  sv: "Lukas",
  svFull: "Lukasevangeliet",
  en: "Luke",
  ar: "لوقا"
}, {
  sv: "Johannes",
  svFull: "Johannesevangeliet",
  en: "John",
  ar: "يوحنا"
}, {
  sv: "Apostlagärningarna",
  svFull: "Apostlagärningarna",
  en: "Acts",
  ar: "أعمال الرسل"
}, {
  sv: "Romarbrevet",
  ...
  svFull: "Första Korintierbrevet",
  en: "1 Corinthians",
  ar: "كورنثوس الأولى"
}, {
  sv: "2 Korintierbrevet",
  svFull: "Andra Korintierbrevet",
  en: "2 Corinthians",
  ar: "كورنثوس الثانية"
}, {
  sv: "Galaterbrevet",
  svFull: "Galaterbrevet",
  en: "Galatians",
  ar: "غلاطية"
}, {
  sv: "Efesierbrevet",
  svFull: "Efesierbrevet",
  en: "Ephesians",
  ar: "أفسس"
}, {
  sv: "Filippierbrevet",
  svFull: "Filipperbrevet",
  en: "Philippians",
  ar: "فيلبي"
}, {
  sv: "Kolosserbrevet",
  svFull: "Kolosserbrevet",
  en: "Colossians",
  ar: "كولوسي"
}, {
  sv: "1 Thessalonikerbrevet",
  svFull: "Första Thessalonikerbrevet",
  en: "1 Thessalonians",
  ar: "تسالونيكي الأولى"
}, {
  sv: "2 Thessalonikerbrevet",
  svFull: "Andra Thessalonikerbrevet",
  en: "2 Thessalonians",
  ar: "تسالونيكي الثانية"
}, {
  sv: "1 Timoteusbrevet",
  svFull: "Första Timoteusbrevet",
  en: "1 Timothy",
  ar: "تيموثاوس الأولى"
}, {
  sv: "2 Timoteusbrevet",
  svFull: "Andra Timoteusbrevet",
  en: "2 Timothy",
  ar: "تيموثاوس الثانية"
}, {
  sv: "Titusbrevet",
  ...
  sv: "Filemonbrevet",
  svFull: "Filemonbrevet",
  en: "Philemon",
  ar: "فليمون"
}, {
  sv: "Hebreerbrevet",
  svFull: "Hebreerbrevet",
  en: "Hebrews",
  ar: "عبرانيين"
}, {
  sv: "Jakobsbrevet",
  ...
  sv: "1 Petrusbrevet",
  svFull: "Första Petrusbrevet",
  en: "1 Peter",
  ar: "بطرس الأولى"
}, {
  sv: "2 Petrusbrevet",
  svFull: "Andra Petrusbrevet",
  en: "2 Peter",
  ar: "بطرس الثانية"
}, {
  sv: "1 Johannesbrevet",
  svFull: "Första Johannesbrevet",
  en: "1 John",
  ar: "يوحنا الأولى"
}, {
  sv: "2 Johannesbrevet",
  svFull: "Andra Johannesbrevet",
  en: "2 John",
  ar: "يوحنا الثانية"
}, {
  sv: "3 Johannesbrevet",
  svFull: "Tredje Johannesbrevet",
  en: "3 John",
  ar: "يوحنا الثالثة"
}, {
  sv: "Judasbrevet",
...
const BG_TEMPLATES = [{
  ...
  name: 'Ocean',
  url: 'https://images.unsplash.com/photo-1505118380757-91f5f45d8de4?auto=format&fit=crop&w=1920&q=80'
}, {
  name: 'Forest',
...
const getChapterFromXml = (xmlString, bookName, chapterNum) => {
  ...
  try {
    ...
    if (!localBookName || /^[A-Z0-9]+$/.test(localBookName)) {
      ...
      if (entry) {
        if (lang === 'ar') localBookName = entry.ar;else if (lang === 'en') localBookName = entry.en;else localBookName = entry.svFull;
      }
    }
...
const BibleCanvas = ({
  ...
  return /*#__PURE__*/_jsx("canvas", {
    ref: canvasRef,
    className: "w-full h-auto rounded-[2rem] shadow-2xl border border-white/10 bg-slate-900"
  });
};
const NumericInput = ({
  label,
  ...
  children: [/*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsx("span", {
      className: "text-[8px] font-bold text-slate-500 uppercase",
      children: label
    }), /*#__PURE__*/_jsxs("div", {
...
const App = () => {
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("header", {
      className: "sticky top-0 z-[100] bg-[#020617]/80 backdrop-blur-xl border-b border-white/5 px-8 h-20 flex items-center justify-between",
      children: [/*#__PURE__*/_jsxs("div", {
        className: "flex items-center gap-4",
        children: [/*#__PURE__*/_jsx("div", {
          className: "bg-indigo-600 p-2.5 rounded-2xl shadow-lg shadow-indigo-500/20",
          children: /*#__PURE__*/_jsx(Lucide.BookOpen, {
            className: "w-6 h-6 text-white"
          })
        }), /*#__PURE__*/_jsxs("div", {
          children: [/*#__PURE__*/_jsxs("h1", {
            className: "text-xl font-black italic tracking-tighter",
            children: ["BIBEL", /*#__PURE__*/_jsx("span", {
              className: "text-indigo-400 not-italic",
              children: "GENERATOR"
            })]
          }), /*#__PURE__*/_jsx("p", {
            className: "text-[10px] text-slate-500 font-bold uppercase tracking-widest",
            children: "Master Edition"
          })]
        })]
      }), /*#__PURE__*/_jsxs("div", {
        className: "flex items-center gap-4",
        children: [activeCastScreen && /*#__PURE__*/_jsxs("div", {
          className: "flex items-center gap-3 bg-indigo-500/10 border border-indigo-500/30 px-4 py-2 rounded-xl animate-pulse",
          children: [/*#__PURE__*/_jsx("div", {
            ...
            children: ["Presenterar på: ", activeCastScreen.label || 'Extern skärm']
          }), /*#__PURE__*/_jsx("button", {
            onClick: stopCasting,
            className: "ml-2 p-1 hover:bg-red-500/20 rounded-lg transition-colors group",
            title: "Avbryt presentation",
            children: /*#__PURE__*/_jsx(Lucide.XCircle, {
              className: "w-4 h-4 text-red-500"
            })
          })]
        }), /*#__PURE__*/_jsxs("button", {
          onClick: handleCast,
          className: "bg-indigo-500 text-white px-8 py-3 rounded-2xl text-sm font-black flex items-center gap-3 hover:bg-indigo-400 transition-all active:scale-95 shadow-2xl shadow-indigo-500/40 border border-indigo-400/30",
          children: [/*#__PURE__*/_jsx(Lucide.Tv, {
            className: "w-5 h-5"
          }), " ", activeCastScreen ? 'BYT SKÄRM' : 'KASTA TILL SKÄRM']
        }), /*#__PURE__*/_jsxs("button", {
          onClick: download,
          className: "bg-white text-slate-900 px-8 py-3 rounded-2xl text-sm font-black flex items-center gap-3 hover:bg-indigo-50 transition-all active:scale-95 shadow-xl shadow-white/5",
          children: [/*#__PURE__*/_jsx(Lucide.Download, {
            className: "w-4 h-4"
          }), " SPARA BILD"]
        })]
      })]
    }), /*#__PURE__*/_jsxs("main", {
      className: "max-w-7xl mx-auto px-8 py-10 grid grid-cols-1 lg:grid-cols-12 gap-12",
      children: [/*#__PURE__*/_jsxs("div", {
        className: "lg:col-span-4 space-y-6",
        children: [/*#__PURE__*/_jsxs("section", {
          className: "bg-indigo-600/10 border border-indigo-500/20 p-6 rounded-[2rem] space-y-4",
          children: [/*#__PURE__*/_jsxs("h2", {
            className: "text-[10px] font-black text-indigo-400 uppercase tracking-widest flex items-center gap-2",
            children: [/*#__PURE__*/_jsx(Lucide.Info, {
              className: "w-4 h-4"
            }), " Kom igång"]
          }), /*#__PURE__*/_jsxs("button", {
            onClick: () => folderInputRef.current.click(),
            className: "w-full bg-indigo-600 hover:bg-indigo-500 text-white py-4 rounded-2xl font-black text-xs uppercase flex items-center justify-center gap-3 transition-all",
            children: [/*#__PURE__*/_jsx(Lucide.Upload, {
              className: "w-4 h-4"
            }), " Ladda in XML-biblar"]
          }), /*#__PURE__*/_jsx("input", {
            type: "file",
            ...
            className: "text-[10px] text-slate-500 font-bold text-center",
            children: [Object.keys(externalXmls).length, " biblar redo i minnet"]
          })]
        }), /*#__PURE__*/_jsxs("section", {
          className: "bg-slate-900/40 border border-white/5 p-6 rounded-[2rem] space-y-6 overflow-y-auto max-h-[70vh]",
          children: [/*#__PURE__*/_jsxs("div", {
            className: "space-y-2",
            children: [/*#__PURE__*/_jsx("label", {
              className: "text-[10px] font-black text-slate-500 uppercase px-1",
              children: "Översättningar"
            }), /*#__PURE__*/_jsx("select", {
              className: "w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-sm font-bold",
              value: ver1.id,
              onChange: e => setVer1(availableTranslations.find(t => t.id === e.target.value) || ver1),
              children: availableTranslations.map(t => /*#__PURE__*/_jsx("option", {
                value: t.id,
                children: t.name
              }, t.id))
            }), /*#__PURE__*/_jsx("select", {
              className: "w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-sm font-bold",
              value: ver2.id,
              onChange: e => setVer2(availableTranslations.find(t => t.id === e.target.value) || ver2),
              children: availableTranslations.map(t => /*#__PURE__*/_jsx("option", {
                value: t.id,
                children: t.name
              }, t.id))
            ...
            children: [/*#__PURE__*/_jsx("h2", {
              ...
              children: [/*#__PURE__*/_jsx("select", {
                ...
                className: "w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 font-bold text-sm appearance-none",
                children: BIBLE_BOOKS.map(book => /*#__PURE__*/_jsx("option", {
                  value: book,
                  children: book
                }, book))
              }), /*#__PURE__*/_jsx("span", {
                className: "absolute -top-2 left-3 bg-[#020617] px-2 text-[8px] font-black text-slate-500 uppercase",
                children: "Bok"
              })]
            }), /*#__PURE__*/_jsxs("div", {
              ...
              children: [/*#__PURE__*/_jsxs("div", {
                ...
                children: [/*#__PURE__*/_jsx("input", {
                  ...
                  onChange: e => {
                    setSelectedChapter(parseInt(e.target.value) || 1);
                    setSelectedVerseIndex(0);
                  },
                  className: "w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-center font-bold"
                }), /*#__PURE__*/_jsx("span", {
                  className: "absolute -top-2 left-3 bg-[#020617] px-2 text-[8px] font-black text-slate-500 uppercase",
                  children: "Kapitel"
                })]
              }), /*#__PURE__*/_jsxs("div", {
                className: "relative flex items-center bg-slate-800 border border-slate-700 rounded-xl",
                children: [/*#__PURE__*/_jsx("button", {
                  onClick: () => setSelectedVerseIndex(v => Math.max(0, v - 1)),
                  className: "p-3 text-indigo-400 hover:bg-white/5 shrink-0 rounded-l-xl",
                  children: /*#__PURE__*/_jsx(Lucide.ChevronLeft, {
                    className: "w-5 h-5"
                  })
                }), /*#__PURE__*/_jsx("input", {
                  type: "number",
                  ...
                  onClick: () => setSelectedVerseIndex(v => Math.min(chapterData1.length - 1, v + 1)),
                  className: "p-3 text-indigo-400 hover:bg-white/5 shrink-0 rounded-r-xl",
                  children: /*#__PURE__*/_jsx(Lucide.ChevronRight, {
                    className: "w-5 h-5"
                  })
                }), /*#__PURE__*/_jsx("span", {
                  className: "absolute -top-2 left-3 bg-[#020617] px-2 text-[8px] font-black text-slate-500 uppercase z-10",
                  children: "Vers"
                })]
              })]
            })]
            ...
            children: [/*#__PURE__*/_jsxs("div", {
              ...
              children: [/*#__PURE__*/_jsx("label", {
                ...
                children: "Design (Sparad)"
              }), /*#__PURE__*/_jsx(Lucide.Save, {
                className: "w-3 h-3 text-indigo-400"
              })]
            }), /*#__PURE__*/_jsx("div", {
              className: "grid grid-cols-3 gap-2",
              children: Object.keys(LAYOUTS).map(r => /*#__PURE__*/_jsx("button", {
                onClick: () => setAspectRatio(r),
                className: `py-2 rounded-xl text-[10px] font-black border transition-all ${aspectRatio === r ? 'bg-white text-black border-white' : 'bg-slate-800 border-slate-700 text-slate-500'}`,
                children: r
              }, r))
            }), /*#__PURE__*/_jsxs("div", {
              className: "space-y-6 bg-slate-800/50 p-5 rounded-[1.5rem] border border-white/5",
              children: [/*#__PURE__*/_jsxs("div", {
                className: "space-y-4",
                children: [/*#__PURE__*/_jsxs("div", {
                  className: "flex items-center gap-2 border-b border-white/5 pb-2",
                  children: [/*#__PURE__*/_jsx(Lucide.Type, {
                    className: "w-3 h-3 text-indigo-400"
                  }), /*#__PURE__*/_jsx("span", {
                    className: "text-[9px] font-black uppercase text-slate-300",
                    children: "Vers-texter"
                  })]
                }), /*#__PURE__*/_jsx(NumericInput, {
                  label: "Vertikalt (Y)",
                  value: shiftVersesY,
                  onChange: setShiftVersesY
                }), /*#__PURE__*/_jsx(NumericInput, {
                  label: "Horisontellt (X)",
                  value: shiftVersesX,
                  onChange: setShiftVersesX
                }), /*#__PURE__*/_jsx(SizeSlider, {
                  label: "Textstorlek",
                  value: sizeVerses,
                  onChange: setSizeVerses
                }), /*#__PURE__*/_jsx(NumericInput, {
                  label: "Mellanrum texter",
                  value: verseGap,
                  onChange: setVerseGap,
                  min: 0,
                  max: 1000
                })]
              }), /*#__PURE__*/_jsxs("div", {
                ...
                children: [/*#__PURE__*/_jsxs("div", {
                  className: "flex items-center gap-2 border-b border-white/5 pb-2",
                  children: [/*#__PURE__*/_jsx(Lucide.FileText, {
                    className: "w-3 h-3 text-indigo-400"
                  }), /*#__PURE__*/_jsx("span", {
                    className: "text-[9px] font-black uppercase text-slate-300",
                    children: "Kapitel & Vers"
                  })]
                }), /*#__PURE__*/_jsx(NumericInput, {
                  label: "Vertikalt (Y)",
                  value: shiftCVY,
                  onChange: setShiftCVY
                }), /*#__PURE__*/_jsx(NumericInput, {
                  label: "Horisontellt (X)",
                  value: shiftCVX,
                  onChange: setShiftCVX
                }), /*#__PURE__*/_jsx(SizeSlider, {
                  label: "Textstorlek",
                  value: sizeCV,
                  onChange: setSizeCV
                ...
                className: "w-full text-[9px] font-black uppercase text-slate-500 hover:text-white transition-colors pt-2 flex items-center justify-center gap-2",
                children: [/*#__PURE__*/_jsx(Lucide.RefreshCw, {
                  className: "w-3 h-3"
                }), " Återställ positioner"]
              })]
            }), /*#__PURE__*/_jsxs("div", {
              ...
              children: [/*#__PURE__*/_jsxs("div", {
                ...
                children: [/*#__PURE__*/_jsx("label", {
                  className: "text-[10px] font-black text-slate-500 uppercase px-1",
                  children: "Bakgrundsmallar"
                }), /*#__PURE__*/_jsx("div", {
                  className: "grid grid-cols-3 gap-2",
                  children: BG_TEMPLATES.map((tmpl, i) => /*#__PURE__*/_jsxs("button", {
                    ...
                    children: [/*#__PURE__*/_jsx("img", {
                      ...
                      className: "absolute inset-0 bg-black/20 hover:bg-transparent transition-colors"
                    })]
                  }, i))
                })]
              }), /*#__PURE__*/_jsxs("button", {
                onClick: () => bgInputRef.current.click(),
                className: "w-full bg-white/5 border border-white/10 py-3 rounded-xl text-xs font-bold uppercase hover:bg-white/10 flex items-center justify-center gap-2",
                children: [/*#__PURE__*/_jsx(Lucide.Layers, {
                  className: "w-4 h-4"
                }), " Egen bakgrund"]
              })]
            }), /*#__PURE__*/_jsx("input", {
        ...
        className: "lg:col-span-8 space-y-10 flex flex-col items-center",
        children: [/*#__PURE__*/_jsx("div", {
          className: "w-full max-w-[600px]",
          children: /*#__PURE__*/_jsx(BibleCanvas, {
          ...
          children: [/*#__PURE__*/_jsxs("div", {
            className: "bg-slate-900/30 p-8 rounded-[2rem] border border-white/5 shadow-inner",
            children: [/*#__PURE__*/_jsx("span", {
              className: "text-[10px] font-black text-indigo-400 uppercase tracking-widest",
              children: ver1.name
            }), /*#__PURE__*/_jsxs("p", {
              className: "mt-4 text-xl font-serif italic text-white leading-relaxed",
              children: ["\"", chapterData1[selectedVerseIndex]?.text || "Väntar på text...", "\""]
            })]
          }), /*#__PURE__*/_jsxs("div", {
            className: "bg-slate-900/30 p-8 rounded-[2rem] border border-white/5 shadow-inner",
            children: [/*#__PURE__*/_jsx("span", {
              ...
              className: "mt-4 text-xl font-serif italic text-slate-400 leading-relaxed",
              children: ["\"", chapterData2[selectedVerseIndex]?.text || "---", "\""]
            })]
          })]
        })]
      })]
    }), showScreenSelector && /*#__PURE__*/_jsx("div", {
      className: "fixed inset-0 z-[200] bg-black/80 backdrop-blur-sm flex items-center justify-center p-6",
      children: /*#__PURE__*/_jsxs("div", {
        className: "bg-slate-900 border border-white/10 p-8 rounded-[2.5rem] max-w-md w-full shadow-2xl",
        children: [/*#__PURE__*/_jsxs("h3", {
          className: "text-xl font-black mb-6 text-center tracking-tighter italic",
          children: ["VÄLJ SKÄRM FÖR ", /*#__PURE__*/_jsx("span", {
            className: "text-indigo-400",
            children: "PRESENTATION"
          })]
        }), isLoadingScreens ? /*#__PURE__*/_jsxs("div", {
          className: "py-12 flex flex-col items-center gap-4",
          children: [/*#__PURE__*/_jsx("div", {
            className: "w-10 h-10 border-4 border-indigo-500/20 border-t-indigo-500 rounded-full animate-spin"
          }), /*#__PURE__*/_jsx("p", {
            className: "text-[10px] font-black uppercase tracking-widest text-slate-500",
            children: "Söker efter skärmar..."
          })]
        }) : screenError ? /*#__PURE__*/_jsx("div", {
          className: "bg-red-500/10 border border-red-500/20 p-6 rounded-2xl mb-6",
          children: /*#__PURE__*/_jsx("p", {
            className: "text-xs text-red-400 font-bold leading-relaxed text-center",
            children: screenError
          })
        }) : /*#__PURE__*/_jsx("div", {
          className: "space-y-3",
          children: screens.map((screen, i) => /*#__PURE__*/_jsxs("button", {
            onClick: () => {
            ...
            children: [/*#__PURE__*/_jsxs("div", {
              children: [/*#__PURE__*/_jsx("div", {
                ...
                children: screen.label || `Skärm ${i + 1}`
              }), /*#__PURE__*/_jsxs("div", {
                className: "text-[10px] text-slate-500 group-hover:text-indigo-200 font-bold",
                children: [screen.width, "x", screen.height, " — ", screen.isPrimary ? 'Huvudskärm' : 'Extern skärm']
              })]
            }), /*#__PURE__*/_jsx(Lucide.Monitor, {
          ...
          children: [/*#__PURE__*/_jsx("button", {
            ...
            children: "Öppna i vanligt fönster istället"
          }), /*#__PURE__*/_jsx("button", {
...
if (container) {
  createRoot(container).render(/*#__PURE__*/_jsx(App, {}));
}